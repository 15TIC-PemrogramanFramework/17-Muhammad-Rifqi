...
* 
*/
class pegawaiadmin extends CI_controller
{
...
$this->load->view('viewadmin/pegawai/pegawai',$data);
}
public function tambah()
		{
			$data=array(
				'action' 	=> site_url('pegawaiadmin/tambah_aksi'),
			...
			$this->load->view('viewadmin/pegawai/pegawai_form',$data);
		}
			function tambah_aksi()
		{
			...
			redirect(site_url('pegawaiadmin'));
		}
		...
		function edit($id)
		{
			...
			'action' 	=> site_url('pegawaiadmin/edit_aksi'),
			'button'	=>'Edit'
			);
			$this->load->view('viewadmin/pegawai/pegawai_form_edit',$data);
		}	
		function edit_aksi()
		{
			$data=array(			
