...
$this->load->view('viewadmin/barang/barang',$data);
}
public function tambah()
		{
			$data=array(
				'action' 	=> site_url('barangadmin/tambah_aksi'),
			...
			$this->load->view('viewadmin/barang/barang_form',$data);
		}
		...
		function edit($id)
		{
			...
			'action' 	=> site_url('barangadmin/edit_aksi'),
			'button'	=>'Edit'
			);
			$this->load->view('viewadmin/barang/barang_form',$data);
		}	
